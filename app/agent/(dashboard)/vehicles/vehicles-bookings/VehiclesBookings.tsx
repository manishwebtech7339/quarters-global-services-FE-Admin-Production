    ...
    },
    {
      ...
      render: (row: any) => (
        <div className="flex items-center justify-center gap-2">
          <Link href={'/agent/vehicles/vehicles-bookings/' + row._id}>
            <Icon name="view" />
          </Link>
          <Link href={'/agent/vehicles/vehicles-bookings/edit/' + row._id}>
            <Icon name="edit" />
          </Link>
          <DeleteConfirm
    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button asChild>
            <Link href="/agent/vehicles/vehicles-bookings/add-booking">
              <Plus />
