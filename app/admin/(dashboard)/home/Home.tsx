...
interface HomeProps {
  ...
  dashboardUsage: DashboardUsageDataType[] | null;
}

const Home = ({ dashboardData, dashboardUsage, recentActivities }: HomeProps) => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xl:gap-6 pb-10">
      {dashboardData && <Summary dashboardData={dashboardData} />}
      <ApplicationTrend />
      <ServiceWiseUsage dashboardUsage={dashboardUsage} />
